...
exports.config = {
	...
	before: function (capabilities, specs) {
		const apiUrl = this.baseUrl.replace('8080', '3000');
		global.chance = new Chance();
		global.api = new Api(`${apiUrl}/api/`);

		browser.addCommand('loginViaApi', (email, password) => {
			const token = browser.call(() => api.loginRequest(email, password));
